...
int main(int argc, char *args[])
{
    ...
    anim.SetConstantPosition(starHelper.GetSpokeNode(0), 0.0, 0.0);
    anim.SetConstantPosition(starHelper.GetSpokeNode(1), 20.0, 20.0);
    anim.SetConstantPosition(starHelper.GetHub(), 10.0, 10.0);
